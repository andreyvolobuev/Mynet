...
class M(Model):
    def __init__(self):
        ...
        self.l2 = Layer(3, 1)
        self.optim = Optim(self.parameters(), lr=0.01)
...
if __name__ == '__main__':
    ...
    """
    m = M.load('tests/test_models/dummy_test2.model')
    ...
    m.save(f'tests/test_models/dummy_test2.model')  # no need to save the model
